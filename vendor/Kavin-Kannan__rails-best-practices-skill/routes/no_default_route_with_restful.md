# Don't Use Default Route if You Use RESTful Design
...
**Note**: This practice is rewritten in our own words based on the concept. The practice itself is a fact about Rails routing security and conventions.
