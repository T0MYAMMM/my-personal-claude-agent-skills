...
Read and follow [`skills/layered-rails/workflows/plan.md`](../skills/layered-rails/workflows/plan.md), applied to the goal you've been given (or to a full assessment if no goal is specified).
