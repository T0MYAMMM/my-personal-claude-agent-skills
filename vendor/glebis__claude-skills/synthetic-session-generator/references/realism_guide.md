...
What separates a believable transcript from an obvious AI-generated one. Apply when authoring the
dialogue in Step 2.
...
- Practitioner's questions match the framework (see `modalities.md`).
- The session shape matches the framework's arc (e.g. CBT agenda→homework→work→homework).
