...
**who** {{situation}}
**our product** {{hook}}
**unlike** {{current_workaround}}
**we** {{pull_rewritten_as_differentiator}}
...
**Hypothesis:** If we {{action}}, then {{expected_result}}, because {{push_or_pull_evidence}}.
**Metric:** {{measurable_metric}}
**Effort:** {{effort_level}}
